...
nav_title: "Mutation observer"
section: "Directives"
source_url: "https://vuetifyjs.com/en/directives/mutate"
...
Source: https://vuetifyjs.com/en/directives/mutate

## Agent Use

Use this page when applying the Vuetify 4 Mutation observer directive and its runtime behavior.

## Overview

The mutation observer directive utilizes the Mutation observer API. It allows you to invoke a callback when targeted elements are updated.
