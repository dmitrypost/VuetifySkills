...
nav_title: "useDate"
section: "API"
source_url: "https://vuetifyjs.com/en/api/use-date"
source_type: "html"
...
Source: https://vuetifyjs.com/en/api/use-date

## Agent Use

Use this page when you need the Vuetify 4 API contract for useDate, including props, events, slots, directives, or composable details.

## API Enrichment

Kind: composable
Locale descriptions: https://github.com/vuetifyjs/vuetify/blob/master/packages/api-generator/src/locale/en/useDate.json
Source file: https://github.com/vuetifyjs/vuetify/blob/master/packages/vuetify/src/composables/date/index.ts
